...
def solicitar_turno(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            # transaction.atomic: si algo falla entre crear/actualizar el
            # Cliente y guardar el Turno, se revierte todo junto. Antes,
            # una falla a mitad de camino podía dejar un Cliente creado
            # sin Turno asociado.
            ...
            # Las tareas de Celery van FUERA del bloque atómico: si el
            # broker (Redis) estuviera caído justo en ese instante, no
            # queremos que eso revierta el turno ya confirmado en la DB.
            ...
            datos_recepcion = {
                ...
                # AGREGADO: antes recepción no sabía qué servicio pidió el cliente.
                'servicio': nuevo_turno.servicio.nombre if nuevo_turno.servicio else 'No especificado',
